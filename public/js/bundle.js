...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2Ztb3ZlIiwiYSI6ImNrbGJwZzZ2bTE4NWUybmxieHV5bDI2ZGoifQ.dBSiA-QErkEyqEKU2idnfg';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      ...
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); // Add popup with location info
...
var stripe = Stripe('pk_test_51IZGGkAr05hh05YA9Gyapeja8jZBe7VuRm8yq89SOwcD9S50H62LZaipeA6MtutJvi432lqsSraGmqbcKQcmVzlr001fPN4F9N');
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    e.preventDefault(); // just for two text fields
